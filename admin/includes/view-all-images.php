...
<div class="u-content home">
	...
	<a href="photos.php?source=add-image" class="upload-image">Upload Image</a>
	<div class="images">
		...
		img.onload = () => {
			...
			image_popup.innerHTML = `
				<div class="con">
					...
					<a href="photos.php?source=delete-image&id=${img_meta.dataset.id}" class="trash" title="Delete Image"><i class="fas fa-trash fa-xs"></i></a>
				</div>
			`;
